...
Write-Host "🚀 Installing MongoDB for Swayam Database..." -ForegroundColor Green
Write-Host ""
...
if (-NOT $isAdmin) {
    ...
    Write-Host "1. Download MongoDB: https://www.mongodb.com/try/download/community" -ForegroundColor White
    Write-Host "2. Run the installer" -ForegroundColor White
    Write-Host "3. Start MongoDB service" -ForegroundColor White
    Write-Host "4. Test: node test-swayam-database.js" -ForegroundColor White
    exit 1
}
...
try {
    ...
    if ($mongodVersion) {
        ...
        Write-Host "💡 Test connection: node test-swayam-database.js" -ForegroundColor Cyan
        exit 0
    }
} catch {
